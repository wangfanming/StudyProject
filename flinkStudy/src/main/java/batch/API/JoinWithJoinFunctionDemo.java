...
public class JoinWithJoinFunctionDemo {
    public static void main(String[] args) throws Exception {
        ...
        DataSet<UserInfo> joinSet = ds1.join(ds2).where(0).equalTo(0).with(new UserInfoJoinFun());
        joinSet.print();

    }

    private static class UserInfoJoinFun implements JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, UserInfo> {
        @Override
